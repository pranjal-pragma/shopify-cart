...
function validate(configuration: CartFeaturesConfiguration): string | null {
  ...
  for (const offer of configuration.free_gift_offers) {
    if (!offer.title.trim() || !offer.source_variant_id) return 'Complete every free gift offer.';
